    ...
    public static partial class Plugin
    {
        ...
        private static readonly Dictionary<string, string> EnglishText =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["qmcentral.tip.select_card"] =
                    "Left click: select the whole stack\nRight click: enter an exact amount",
                ...
                ["qmcentral.recycle_confirm"] = "CONFIRM {0}",
                ...
                ["qmtrade.take_back"] = "RECOVER STASH",
                ...
                ["qmtrade.buy_summary"] = "CART {0} KINDS / TOTAL {1}",
                ["qmtrade.sell_summary"] = "EST. INCOME {0} / POINTS {1}",
                ...
                ["qmtrade.stock"] = "STOCK {0}",
                ["qmtrade.owned"] = "OWNED {0}",
                ...
                ["qmtrade.unsellable"] = "NOT ACCEPTED",
                ["qmtrade.quest"] = "QUEST",
                ...
                ["qmtrade.recycle_blocked"] =
                    "Recycling is in progress - selling is blocked",
                ["qmtrade.cargo_default"] = "CARGO",
                ["qmtrade.dialog_buy"] =
                    "Buy the cart for {0} trade points?",
                ["qmtrade.dialog_sell"] = "Sell the selected items?",
                ["qmtrade.cat.all"] = "ALL",
                ...
                ["qmtrade.tip.storage"] = "Pick which ship storage to sell from",
                ...
                ["qmtrade.tip.buy"] = "Buy the whole cart",
                ["qmtrade.tip.sell"] = "Sell the whole cart",
                ["qmtrade.tip.trade"] =
                    "Complete all pending sells and buys at once",
                ["qmtrade.tip.clear"] = "Clear the cart",
                ["qmtrade.tip.take_back"] =
                    "Move everything left in the station's staging area back to cargo",
        ...
        private static readonly Dictionary<string, string> ChineseText =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["qmcentral.recycle_confirm"] = "确认 {0}",
                ["qmcentral.recycle_dialog"] =
                ...
                ["qmtrade.buy_summary"] = "购物车 {0} 种 / 合计 {1}",
                ["qmtrade.sell_summary"] = "预计收入 {0} / 贸易点 {1}",
                ["qmtrade.stock"] = "库存 {0}",
                ["qmtrade.owned"] = "持有 {0}",
                ...
                ["qmtrade.recycle_blocked"] = "回收正在进行，暂时无法出售",
                ["qmtrade.cargo_default"] = "货舱",
                ["qmtrade.dialog_buy"] = "花费 {0} 贸易点购买购物车中的商品？",
                ["qmtrade.dialog_sell"] = "出售选中的物品？",
                ["qmtrade.cat.all"] = "全部",
                ...
                ["qmtrade.tip.buy"] = "购买购物车中的全部商品",
                ["qmtrade.tip.sell"] = "出售购物车中的全部物品",
                ["qmtrade.tip.trade"] = "一次完成全部待处理的出售与购买",
                ["qmtrade.tip.clear"] = "清空购物车",
                ["qmtrade.tip.take_back"] = "把空间站暂存区里剩余的物品取回货舱",
